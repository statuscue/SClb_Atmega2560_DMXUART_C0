/*
 Name:		SClb_Atmega2560_DMXUART_C0.h
...
#ifndef _SClb_Atmega2560_DMXUART_C0_h
#define _SClb_Atmega2560_DMXUART_C0_h

#include <Arduino.h>
#include <inttypes.h>

#define DMX_MIN_SLOTS_U0 24
#define DMX_MAX_SLOTS_U0 512

#define DIRECTION_PIN_NOT_USED_U0 255

typedef void(*SCReceiveCallback)(int);

class SClb_Atmega2560_DMXUART_C0 {

public:
	SClb_Atmega2560_DMXUART_C0(void);
	~SClb_Atmega2560_DMXUART_C0(void);
...
private:
   ...
   */
	uint8_t  _dmxData[DMX_MAX_SLOTS_U0 + 1];
};

extern SClb_Atmega2560_DMXUART_C0 SCDMXUSART0;

#endif // ifndef SClb_Atmega2560_DMXUART_C0_H
